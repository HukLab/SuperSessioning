...
m0=load([obj.XFolder(obj.singleSessionFolder) filesep obj.singleSessionFiles{IndList(1)}]);
m=m0.m;
for ch=1:m.Nch
    z=struct();
    z.RecId={};
    ...
    for ii=2:nSessions
        ...
        load([obj.XFolder(obj.singleSessionFolder) filesep obj.singleSessionFiles{IndList(ii)}])
    ...
    save([obj.XFolder(obj.hashFolder) filesep obj.subject '_ch' num2str(ch) '_hash.mat'],'z','-v7.3')
end
end